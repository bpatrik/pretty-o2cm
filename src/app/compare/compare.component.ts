...
export class CompareComponent {
  ...
  constructor(public dataService: DataService,
    ...
    route.queryParams.subscribe((value: Params) => {
      if (value[QueryParams.competitor.fistName] && value[QueryParams.competitor.lastName] &&
        !this.competitor || (value[QueryParams.competitor.fistName] !== this.competitor.firstName &&
          value[QueryParams.competitor.lastName] !== this.competitor.lastName)) {
        this.competitor = {
          firstName: value[QueryParams.competitor.fistName],
